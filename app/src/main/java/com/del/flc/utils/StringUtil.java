...
public class StringUtil {
    ...
    public static String _break = new String(new byte[]{13, 10});
    ...
    public static Float parseDigit(Object s) {
        try {
            return isTrimmedEmpty(s) ? null : new Float(s.toString());
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static boolean endWithBreak(String s) {
        return s.endsWith(_break);
    }
